...
*Note that more than one answer can be correct. You can use the following code chunk to re-run the model. Alternatively, the correct regression output is also already stored in an object called `out_multivar`.*
...
question("What does the estimated regression model tell us about the relationship between government coalition types (`govtype_mod`) and the share of votes opposed to the government?",
  ...
  answer("Opposition parties facing a minimal-coalition government vote on average 0.04 percentage points more often against the government than opposition parties facing a surplus coalition government, holding everthing else contant.", correct = F, message = "Make sure that your reference category is correct."),
...
```{r encode, echo=FALSE}
learnrhash::encoder_ui(default_ui(url = "https://ilias.uni-mannheim.de/ilias.php?baseClass=ilObjSurveyGUI&ref_id=1114219&cmd=infoScreen"))
```
